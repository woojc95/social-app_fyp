...
export class EditProfilePage implements OnInit {
  ...
  uploadPic(event) {
		...
		this.presentAlert('Done!', 'Your profile picture was updated!')
  }
  ...
  async updateDetails() {
		...
		try {
      await this.user.reAuth(this.user.getUsername(), this.password) // firebase require user to log in before they can change password
		} catch(error) {
			this.busy = false
